...
class Movie():
    ...
    This is a storage container for movie data to be which is used on the
    fresh tomatoes web page. Additionaly the show_trailer method can be called
    to open the trailer's webpage.
